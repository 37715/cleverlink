    ...
    <div className="min-h-screen w-screen flex flex-col justify-center items-center relative">
      ...
      <div className="text-center max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <FadeIn className="mb-12 mt-8">
          <h1 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wider text-black font-ultra-light mb-2">
            cleverlink
          </h1>
        ...
        <ScrollReveal delay={0.2} className="mb-8 sm:mb-12">
          <div className="h-16 sm:h-20 md:h-28 lg:h-32 flex items-center justify-center px-4 w-full">
            <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-ultra-light leading-tight text-black tracking-wide text-center w-full">
              <span className="block font-heading font-light w-full">
                <TextRotate
                  ...
                  elementLevelClassName="font-heading font-light text-black text-center block w-full"
        ...
        <ScrollReveal delay={0.4} className="mb-8 sm:mb-12 px-4">
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-ultra-light text-center">
          ...
          <div className="flex flex-col items-center px-4 max-w-lg mx-auto">
            <div className="flex flex-col sm:flex-row w-full gap-3 sm:gap-0">
              ...
              <input
                ...
                className={`w-full sm:w-auto flex-1 px-6 sm:px-8 py-3 sm:py-4 bg-transparent border border-black font-ultra-light text-sm sm:text-base tracking-wide text-black placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-black/50 sm:rounded-none transition-colors duration-300 ${
              ...
              <button 
                ...
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border border-black bg-black text-white font-ultra-light text-sm sm:text-base tracking-wide hover:bg-gray-800 transition-colors duration-300 group sm:border-l-0 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            {/* Error Message */}
            {emailError && (
              <div className="mt-3 text-red-500 text-xs sm:text-sm font-ultra-light tracking-wide">
                {emailError}
              </div>
            )}
          </div>
